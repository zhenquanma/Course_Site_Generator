...
public class AppStartupConstants
{
    ...
    public static final String APP_PROPERTIES_FILE_ENGLISH_NAME = "app_properties_english.xml";
    public static final String APP_PROPERTIES_FILE_CHINESE_NAME = "app_properties_chinese.xml";
    ...
    public static final String PATH_EXPORT = "../Courses/";
    ...
    public static String PROPERTIES_FILE_ERROR_ENGLISH_MESSAGE = "Error Loading " + APP_PROPERTIES_FILE_ENGLISH_NAME;
    public static String PROPERTIES_FILE_ERROR_CHINESE_MESSAGE = APP_PROPERTIES_FILE_CHINESE_NAME + " 读取错误";

    // ERROR DIALOG CONTROL
    public static String CLOSE_BUTTON_LABEL = "Close";
    
    //LANGUAGE CHOICE BEFORE LAUNCHING THE APPLICATION.
    public static String ENGLISH_STRING = "English";
    public static String CHINESE_STRING = "中文";
    
    //ALERT DIALOG
    public static String ALERT_TITLE = "Language Choice";
    public static String ALERT_HEADER_TEXT = "Choose Your Language:";
